        ...
        children: [
          SizedBox(
              ...
              child: CustomInputWidget(
                  controller: controller.internalCodeController,
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 10),
                    const Text("¿Tarjeta Azul?"),
                  const SizedBox(width: 10),
                  Obx(() => CustomCheckbox(
                      value: controller.blueCardController.value,
                      onChanged: (value) {
                        controller.blueCardController.value = value!;
                      },
          ...
          SizedBox(
              width: width,
              child: CustomInputWidget(
                  controller: controller.administrativeDepartmentController,
          ...
          SizedBox(
              width: width,
              child: CustomInputWidget(
                  controller: controller.socialSecurityCodeController,
                  label: "Código Seguridad Social",
                  hintText: "",
          ...
          SizedBox(
              ...
              child: CustomInputWidget(
                  ...
                  label: "Agencia",
                  hintText: "",
                  prefixIcon: Icons.location_city)), // replace with dropdown
          SizedBox(
              width: width,
              child: CustomInputWidget(
          ...
          SizedBox(
              width: width,
              child: CustomInputWidget(
                  controller: controller.hiringMethodController,
          ...
          SizedBox(
              width: width,
              child: CustomInputWidget(
                  controller: controller.workCountryController,
          ...
          SizedBox(
              width: width,
              child: CustomInputWidget(
                  controller: controller.workShiftController,
